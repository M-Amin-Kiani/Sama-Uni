...
import { professorsignupAPI } from "@/utils/api/signup";
    ...
    >
      ...
      >
        <div className={"flex flex-col text-center gap-1 mb-5"}>
          ...
          <p className={"text-sm text-gray-300"}> ثبت نام استاد</p>
        </div>
        ...
        >
          ...
          <Link className="mt-5 hover:text-[#76ABAE]" href="/sign-up">
            ثبت نام دانشجو
          </Link>
